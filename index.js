...
const {
  ...
  const imgUrl = config.START_IMG || "https://cdn.inprnt.com/thumbs/5d/0b/5d0b7faa113233d7c2a49cd8dbb80ea5@2x.jpg";
...
> _© Crafted with 💖 by Bandaheali_`;
        ...
        fs.writeFileSync(welcomeFlagPath, 'sent'); // ✅ Mark welcome sent
      }
    }
  });
...
try {
  ...
  const udp = botNumber.split('@')[0];
    const jawad = ('923422244714', '923143200187', '923253617422');
