...
cmd({ 
    ...
    try { 
        ...
        let ytmsg = `*🎞️ EDITH-MD YT VIDEO DOWNLOADER 🎞️*
...
const yt = await ytsearch(q);
    ...
    let ytmsg = `*🎧 EDITH-MD YT MP3 DOWNLOADER 🎧*
...
async (conn, mek, m, { from, quoted, q, reply }) => {
  try {
    ...
    let ytmsg = `*🎧 ᴇᴅɪᴛʜ-ᴍᴅ YT MP3 DOWNLOADER 🎧*
...
async (conn, mek, m, { from, q, reply }) => { 
    try { 
        ...
        let caption = `*📽️ ᴇᴅɪᴛʜ-ᴍᴅ YT VIDEO DOWNLOADER 📽️*
